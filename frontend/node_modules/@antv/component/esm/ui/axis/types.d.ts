...
export type LabelOverlapCfg = EllipsisOverlapCfg | RotateOverlapCfg | HideOverlapCfg | WrapOverlapCfg | CustomOverlapCfg;
...
export type AxisTruncateStyleProps = {
     ...
     */
    shape?: Callable<ExtendDisplayObject | [ExtendDisplayObject, ExtendDisplayObject], CallbackParameter<AxisDatum, [Vector2, Vector2]>>;
};
...
export type AxisBaseStyleProps = PrefixStyleProps<Partial<AxisTitleStyleProps>, 'title'> & PrefixStyleProps<Partial<AxisLineStyleProps>, 'line'> & PrefixStyleProps<Partial<AxisTickStyleProps>, 'tick'> & PrefixStyleProps<Partial<AxisLabelStyleProps>, 'label'> & PrefixStyleProps<Partial<AxisGridStyleProps>, 'grid'> & PrefixStyleProps<Partial<AxisTruncateStyleProps>, 'trunc'> & {
